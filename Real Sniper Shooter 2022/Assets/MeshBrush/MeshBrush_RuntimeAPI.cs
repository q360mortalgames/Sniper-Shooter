...
public class MeshBrush_RuntimeAPI : MonoBehaviour {
    ...
    public Vector4 randomScale { //The X and Y components of the Vector4 represent the minimum and maximum random width, and the Z and W components represent the min./max. height.
    ...
    {
        if (paintHit.collider.transform.Find("Holder") == false) //Set up a holder object in case we don't have one yet.
        {
    ...
    private void ApplyRandomScale(GameObject sMesh) //Random, non-uniform custom range scale.
    {
