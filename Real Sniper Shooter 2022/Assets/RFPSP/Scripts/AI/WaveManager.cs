...
public class WaveManager : MonoBehaviour {
	...
	private TextMesh WarmupGUIText1;
	private TextMesh WarmupGUIText2;
	...
	void Start () {
		...
		WarmupGUIText1 = WarmupText.GetComponent<TextMesh>();
		WarmupGUIText2 = WarmupText2[1].GetComponent<TextMesh>();
