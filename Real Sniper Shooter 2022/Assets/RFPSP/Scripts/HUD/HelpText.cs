...
public class HelpText : MonoBehaviour {
	...
	private TextMesh guiTextComponent;
	private float oldWidth;//to track screen size change
	
	void Start(){
		guiTextComponent = GetComponent<TextMesh>();
		...
		//this.GetComponent<TextMesh>().enabled = true;
		startTime = Time.time;
	...
	void Update (){
		...
		//Color tempColor = GetComponent<TextMesh>().material.color; 
